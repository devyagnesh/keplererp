<x-layouts.app title="Add employee">
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1 class="page-title fw-medium fs-18 mb-2">Add employee</h1>
            <nav>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    <form id="employeeForm" method="POST" action="{{ route('admin.hr.employees.store') }}" novalidate>
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Employee code</label>
                            <input type="text" name="emp_code" class="form-control" required maxlength="32">
                        </div>
                        <div class="mb-3">
                        ...
                        @include('admin.hr._employee-payroll-fields')
                        <button type="submit" class="btn btn-primary" id="employeeSubmit">Create</button>
    ...
    @push('scripts')
        <script>
            window.employeeFormSubmitUrl = @json(route('admin.hr.employees.store'));
            window.employeeFormMethod = 'POST';
