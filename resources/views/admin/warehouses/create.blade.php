<x-layouts.app title="Add warehouse">
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1 class="page-title fw-medium fs-18 mb-2">Add warehouse</h1>
            <nav>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form id="warehouseForm" method="POST" action="{{ route('admin.warehouses.store') }}" novalidate>
                        @csrf
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary" id="warehouseSubmit">Create</button>
    ...
    @push('scripts')
        <script>
            window.warehouseFormSubmitUrl = @json(route('admin.warehouses.store'));
            window.warehouseFormMethod = 'POST';
