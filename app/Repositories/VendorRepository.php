...
/**
 * Eloquent implementation of {@see VendorRepositoryInterface}.
 */
class VendorRepository implements VendorRepositoryInterface
{
    ...
    public function getDataTableRows(Request $request): array
    {
        ...
        $orderable = ['id', 'vendor_code', 'name', 'phone', 'gstin', 'city', 'status', 'created_at'];
        ...
        /** @var Collection<int, Vendor> $rows */
